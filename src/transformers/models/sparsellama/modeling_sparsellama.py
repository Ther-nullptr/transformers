...
class SparseLlamaGEMM(nn.Module):
    def __init__(self):
        super().__init__()
...
class SparseLlamaHadamard(nn.Module):
    def __init__(self):
        super().__init__()
...
class SparseLlamaMLP(nn.Module):
    def __init__(self, config: SparseLlamaConfig):
        ...
        self.hadamard = SparseLlamaHadamard()
...
class LlamaAttention(nn.Module):
    ...
    def __init__(self, config: SparseLlamaConfig):
        ...
        self.gemm1 = SparseLlamaGEMM()
        self.gemm2 = SparseLlamaGEMM()
        self._init_rope()
