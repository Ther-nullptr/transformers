...
from .vit_quant_baseline import FusedViTLayer
...
class ViTLayer(nn.Module):
    ...
    def __init__(self, config: ViTConfig) -> None:
        ...
        self.fused_vit_layer = FusedViTLayer(config.hidden_size, config.num_attention_heads)
    ...
    def forward(
        ...
        # if self.training:
        outputs = self.fused_vit_layer.forward(
            hidden_states,
