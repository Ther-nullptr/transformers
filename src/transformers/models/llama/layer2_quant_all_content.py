...
class FusedLlamaLayerFunc(torch.autograd.Function):
    ...
    def backward(ctx, grad_output: torch.Tensor, *args):
        ...
        # down proj part
        grad_w_down_lora_a, grad_w_down_lora_b, grad_down = lora_backward_fp32(w_down, w_down_quant_state, w_down_lora_a, w_down_lora_b, hadamard, down_lora_a, grad_output)
        del hadamard
        ...
        # gate proj part
        grad_w_gate_lora_a, grad_w_gate_lora_b, grad_gate = lora_backward_fp32(w_gate, w_gate_quant_state, w_gate_lora_a, w_gate_lora_b, x_norm_2, gate_lora_a, grad_fn)
        del grad_fn
        
        # up proj part
        grad_w_up_lora_a, grad_w_up_lora_b, grad_up = lora_backward_fp32(w_up, w_up_quant_state, w_up_lora_a, w_up_lora_b, x_norm_2, up_lora_a, grad_hadamard_2)
        ...
        # o part
        grad_w_o_lora_a, grad_w_o_lora_b, grad_o = lora_backward_fp32(w_o, w_o_quant_state, w_o_lora_a, w_o_lora_b, o, o_final_lora_a, grad_medium)
        del o
        ...
        # backward of q_proj
        grad_w_q_lora_a, grad_w_q_lora_b, grad_x = lora_backward_fp32(w_q, w_q_quant_state, w_q_lora_a, w_q_lora_b, x_norm_1, q_lora_a, grad_q)

        # backward of k_proj
        grad_w_k_lora_a, grad_w_k_lora_b, grad_x_temp = lora_backward_fp32(w_k, w_k_quant_state, w_k_lora_a, w_k_lora_b, x_norm_1, k_lora_a, grad_k)
        grad_x += grad_x_temp

        # backward of v_proj
        grad_w_v_lora_a, grad_w_v_lora_b, grad_x_temp = lora_backward_fp32(w_v, w_v_quant_state, w_v_lora_a, w_v_lora_b, x_norm_1, v_lora_a, grad_v)
        grad_x += grad_x_temp
...
class FusedLlamaLayer(torch.nn.Module):
    ...
    def forward(
        ...
        y, x_channel_idx, x_scale, \
            ...
            up_channel_idx, up_scale, \
            fn_channel_idx, fn_scale, \
            hadamard_channel_idx, hadamard_scale = FusedLlamaLayerFunc.apply(
            input,
            #############attention part#############
            norm_weight_1,
            norm_bias_1,
