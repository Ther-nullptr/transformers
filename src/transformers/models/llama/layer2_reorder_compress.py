...
class FusedLlamaLayerFunc(torch.autograd.Function):
    ...
    def backward(ctx, grad_output: torch.Tensor, *args):
        ...
        gate = gate_main + gate_lora_a @ w_gate_lora_b.to(gate_main.dtype)
        del gate_main
        ...
        up = up_main + up_lora_a @ w_up_lora_b.to(up_main.dtype)
        del up_main
        ...
        v = v_main + v_lora_a @ w_v_lora_b.to(v_main.dtype)
        ...
        q = q_main + q_lora_a @ w_q_lora_b.to(q_main.dtype)
        ...
        k = k_main + k_lora_a @ w_k_lora_b.to(k_main.dtype)
