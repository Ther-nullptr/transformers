...
class FusedLlamaLayer(torch.nn.Module):
    def __init__(
        ...
        self.q_bit = 2
        self.quant_type = 'layernorm' # ['layernorm', 'linear', 'gemm', 'silu', 'hadamard']
